...
const PAGE1_BRANCH = [
  {
    ...
    icon: '🌬️',
    title: '스마트 동선으로 시작',
    body: '큰 버튼 하나로 그 지역 축제와 인기 스팟을 오전·오후 일정으로 채워 드려요. 인기 1위와 그날 축제는 오전에 두고, 방문일이 휴무이거나 마감에 닿는 곳은 빼요. 식당·카페는 근처에서 고르면 되고 자동 일정에는 넣지 않아요.',
  },
  {
    tag: 'B',
    icon: '📖',
...
const PAGE2_STEPS = [
  {
    ...
    body: '위쪽 「← 메인」을 누르면 여행 만들기 화면으로 돌아가요. 일정 화면은 아래 탭으로 다섯 구간을 오가요. 홈에서 오늘 일정을 보고, 지도에서 동선을, 검색에서 장소를 더 담고, 알림에서 온 메시지를, 프로필에서 글씨·알림·마무리를 다뤄요.',
  },
  {
    icon: '📋',
    title: '일정 카드 다루기',
  ...
  },
  {
    icon: '🌀',
    title: '변수에 바로 대응하기',
    body: '홈 위쪽 바람개비와 「지금 변수에 대응하기」 세 장(비·폭염 / 혼잡 / 동선)이 여행 당일 이미 담은 일정을 90초마다 다시 봐요. 반짝이면 실내·한산한 곳·짧은 동선으로 바로 바꿀 수 있어요. 휴무·마감·이동시간 부족도 바람개비가 잡아 주고, 「동선 다시」로 순서를 다시 짤 수 있어요.',
  },
  {
    icon: '✅',
    title: '알림 · 마무리 · 공유',
