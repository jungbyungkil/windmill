...
const PAGE2_STEPS = [
  {
    ...
    body: '오늘 일정 아래에 지도, 장소 검색, 알림, 프로필이 이어져 있어요. 위쪽 흐름 표시나 아래 탭을 누르면 그 구간으로 바로 이동해요.',
  },
  {
    icon: '🏷️',
    title: '태그 선택 → 추천받기',
    ...
    body: '일정 화면 위쪽 바람개비와 바로 아래 세 장(비·폭염 / 혼잡 / 동선)이 지금 상황을 알려줘요. 반짝이면 그 버튼을 눌러 실내·한산한 곳·짧은 동선으로 바로 바꿀 수 있어요. 프로필에서 알림을 켜 두면 앱을 닫아 두어도 휴대폰으로 알려드려요.',
  },
  {
    icon: '✅',
