...
export default function PinwheelHero({
  ...
  // 서브·원인 라벨·상세 목록·말풍선)는 걷어낸다. 비·폭염·혼잡 카드도 같은 방식으로 단순화
  // (2026-09-13 후속 요청). 액션 직후 낙관적 성공 스킨은 별개 상태라 그대로 보여준다.
  const simplifyCard = (tangleMode || heatMode || rainMode || crowdMode) && !showOptimistic;
